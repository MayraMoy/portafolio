    ...
    return (
        <nav className="navbar">
            <div className="divlogo">
                <a href="#inicio">
                    <img className="logo" style={{ height: '40px', width: '71px' }} src={logo} alt="Logo de Mayra" width="71" height="40" />
                </a>
            </div>
            ...
            <div className="navbar-actions">
                <div className="divsocial">
                    <a href="https://github.com/MayraMoy" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social" title=" Mi GitHub">
                    ...
                    <a href="https://www.linkedin.com/in/mayra-yazmin-moyano/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social" title=" Mi LinkedIn">
                ...
                <div className="cv-download">
                    <a href="/CV_MAYRA_YAZMIN_MOYANO.pdf" download="CV_MAYRA_YAZMIN_MOYANO.pdf" aria-label="Descargar CV" title="Descargar mi CV">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1035a8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="divbutton">
                    <a href="mailto:mayrayazminmoyano@gmail.com" aria-label="Contáctame" className="button">Contáctame</a>
                </div>
